import argparse
#/media/yujiaguo/29719e14-8bb8-4829-90a4-727c2e661fc4/JCY/dataset/
import torch
def get_opt():
    ...
    parser.add_argument('--Lp1', type=float, default=10)
    parser.add_argument('--gamma', type=int, default=2)
    parser.add_argument('--delta', type=float, default=0.45)
    parser.add_argument('--seen_classes', type=float, default=40)
    parser.add_argument('--nclasses', type=float, default=50)
